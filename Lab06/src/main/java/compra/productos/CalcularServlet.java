 ...
 * @author LUCHO
 */
@WebServlet(name = "CalcularServlet", urlPatterns = {"/Calcular"})
public class CalcularServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (cantidadProducto < 0) {
            request.setAttribute("mensaje", "Lo siento, ingrese una cantidad positiva.");
    ...
    public String getServletInfo() {
        return "Servlet que calcula el total a pagar por los productos";
    }// </editor-fold>
